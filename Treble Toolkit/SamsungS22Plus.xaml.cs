...
{
    /// <summary>
    /// Interaction logic for SamsungS22Plus.xaml
    /// </summary>
    public partial class SamsungS22Plus : Page
    {
        public SamsungS22Plus()
        {
            InitializeComponent();
        ...
        {
            Uri uri = new Uri("SamsungS22PlusDSF.xaml", UriKind.Relative);
            this.NavigationService.Navigate(uri);
        }
        ...
        private void More()
        {
            ...
            startInfo.Arguments = "/C start https://www.samsung.com/us/smartphones/galaxy-s22/";
